...
$h_3$ runs $k$ independent A* searches in parallel from randomly sampled starting nodes, each using a base heuristic, and returns the most profitable result.

\subsection{$h_4$ -- Chain Congestion and Exchange Reliability}

$h_4$ penalizes transfer latency and operational risk using pre-computed chain transfer times and static reliability scores $s(n) \in [0,1]$:
\[
