...
\begin{figure}[ht]
    ...
    a profitable path. Each node represents an (exchange, asset) pair, with node
...
%\input{sec/5.3_Proposed_Methods} gonna remove this section as it is onlly an extra table that I do not need. Paths can be verified through githu results folders
